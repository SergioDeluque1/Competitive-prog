...
public class PrimalityTest {
    ...
    public static boolean isPrime(int n) {
        for (int i = 2; i < n; i++) { // i starts in 2, making sure n>=1
            if (n % i == 0 ) {
                return false;
            }
        }
    ...
    public static void main(String[] args) {
         ...
         try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                } catch (NumberFormatException e) { // making sure all lines are integers
                   return;
                }
            }
        } catch (IOException e) { // handle no file exeption
            System.exit(1);
        }
